          ...
          <section className="position-relative lg-mt-80 mt-140">
            <div className="container">
              <div className="pb-60 lg-pg-40 pt-30">
                <h2 className="text-center pb-5">Solar Rooftop</h2>
                <p className="text-center">
                  Harness solar energy for homes and businesses with <b>rooftop solar systems</b>, designed for maximum efficiency and savings
                </p>
              </div>
            </div>
          </section>
