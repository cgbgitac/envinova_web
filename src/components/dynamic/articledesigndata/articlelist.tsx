      ...
      <div className="container">
        <div className="position-relative">
          <div className="row gx-xxl-5 m-auto justify-content-center">
            <div className="mediaHeadings"> 
              <h2 className="text-center py-5">The Envinova Journal</h2>
              <p className="pb-50 text-center">Stay updated with the latest in solar innovation, sustainability, and smart infrastructure. From industry insights to our journey in transforming public spaces, explore stories that shape the future of clean energy. Dive in and discover how we’re making an impact!</p>
            </div>
