      ...
      <div className="container">
        <div className="position-relative">
          <div className="row gx-xxl-5">
            <div>
              <h2 className="text-center py-5">Our Projects</h2>
              <p className="pb-50 text-center">Read how we’ve transformed public infrastructure with our innovative solar solutions! With installations in 10+ cities and expanding PAN India, our projects are redefining how solar energy integrates into everyday life. Explore how each installation is changing the way we experience sustainable technology.</p>
            </div>
            {loading ? (
